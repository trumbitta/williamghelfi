$(function() {
	...
	$('.color-switcher a').click(function() {
		...
		$('#color-scheme').attr('href','/salesbury-1.0.0/css/salesbury-'+ c +'.css?x='+ cacheBuster);
	});
	...
	$('.background-switcher a').click(function() {
		...
		$('#background-pattern').attr('href','/salesbury-1.0.0/css/salesbury-bg-'+ c +'.css?x='+ cacheBuster);
	});
