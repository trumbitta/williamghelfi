...
Despite [eroic efforts of keeping changes small](https://www.gitpod.io/blog/gitpod-core-values#ship-skateboards), in the real world you are likely to be working on the same task for days.  
