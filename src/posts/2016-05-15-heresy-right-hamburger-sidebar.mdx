...
- _If some more remain_, put them in a off-canvas navigation menu and use a de-facto standard icon on the toggle button: <button class="btn btn-default icon icon-reorder"></button>
