...
<UiFigureWithCaption caption='<em>Haters gonna hate (6x)</em> – Giordano Bruno. Photo by
...
![](../assets/images/posts/2016-05-15-heresy-right-hamburger-sidebar/bruno.jpg 'wela')
...
- _If some more remain_, put them in a off-canvas navigation menu and use a de-facto standard icon on the toggle button: <UiButton icon={faBars}></UiButton>
