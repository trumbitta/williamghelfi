...
<Figure caption='HTML &amp; CSS - The easy path. <a href="https://leanpub.com/easyhtmlcss">Get it on Leanpub.com.</a>'>

![](../assets/images/posts/2014-02-20-new-book-html-css-the-easy-path/easyhtmlcss.png)
...
<Figure caption='Image by Paul Inkles: <a href="http://www.visioncreation.co.uk/">http://www.visioncreation.co.uk/</a> used under <a href="http://creativecommons.org/licenses/by/2.0/">http://creativecommons.org/licenses/by/2.0/</a>'>

![](../assets/images/posts/2014-02-20-new-book-html-css-the-easy-path/baby-computer.jpg)
...
Those were the days of _"Wow! How is it done?"_ and of _"Let me check what happens if I right click... just... here."_ and then a promising `View HTML` menu item would appear to bring you in the realm of the unknown.

As it happens, nothing has changed.

HTML is still there – although now tightly coupled with its _Best Friend Forever_ the CSS, Cascading Style Sheets – and its importance has not decreased.
...
It will be then time to introduce the CSS, quickly showing the most useful properties in the topics of _typography_, _positioning_, and more.
Then, having learned about positioning, you'll see the common elements of a classic layout, the _not-so-common_ elements of a classic layout, and a solid introduction to some – guess what? – _classic types of layout_.

<Figure caption='<em>"Understanding CSS layouts is way easier than intergalactic rocket science." – James T. Kirk.</em> Image by <a href="http://www.flickr.com/photos/cardoso/">http://www.flickr.com/photos/cardoso/</a> used under <a href="http://creativecommons.org/licenses/by/2.0/">http://creativecommons.org/licenses/by/2.0/</a>'>

![](../assets/images/posts/2014-02-20-new-book-html-css-the-easy-path/enterprise-blueprint.jpg)
...
After a couple more useful HTML elements like forms, tables, and others, there will come my favorite chapter – with subsequent _hands-on time_ – where you'll have some fun with background images, gradients, borders, and shadows.
...
3. An introduction to JavaScript
   JavaScript is a scripting language every major browser understands. It is primarly used to add a _behavioral_ layer on top of the _semantic_ and _presentational_ layers provided by HTML and CSS.
   This separation of concerns, is one of the pillars of _progressive enhancement_.

<Figure caption='Progressive enhancement as in <a href="http://alistapart.com/article/understandingprogressiveenhancement">http://alistapart.com/article/understandingprogressiveenhancement</a> by Aaron Gustafson'>

![](../assets/images/posts/2014-02-20-new-book-html-css-the-easy-path/m-m.jpg)
