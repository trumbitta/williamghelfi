...
<figure>
  ...
  <figcaption>This is madness, and I promise you no Spartan ain't going to kick me in a well for writing it.</figcaption>
</figure>
...
<label htmlFor="icecream">Choose an icecream:</label>
<br />
...
<label htmlFor="superheroes">Show superheroes:</label>
<br />
...
<label htmlFor="opponent">Choose your opponent:</label>
<br />
<select name="opponent" id="opponent" defaultValue="indiana_jones">
  <option value="godzilla">Godzilla</option>
  <option value="optimus_prime">Optimus Prime</option>
  <option value="shaq">Shaq</option>
  <option value="batman">Batman</option>
...
<label htmlFor="opponent-2">Choose your opponent:</label>
<br />
